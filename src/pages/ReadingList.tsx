export default function ReadingList() {
  return (
    <section className="page-section">
      <h1 className="section-heading">Recommended Reading</h1>
      ...
      <p className="text-block">
        ...
        <span className="font-medium text-gray-900">Sergey Levine</span>. Their
        perspectives continue to influence how I think about deep learning,
      ...
      <ul className="reading-list">
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
          >
            Dueling Network Architectures for Deep Reinforcement Learning (Wang
            et al., 2015)
          </a>{" "}
          — a clever way to decouple state values and advantages in deep
          Q-learning.
        </li>
        ...
        <li>
          ...
          — an intuitive guide to recurrent networks; useful even if you don’t
          work with RNNs.
        </li>
      </ul>
